...
__webpack_require__(/*! ./proofajax */ "./resources/js/proofajax.js");
...
if (proofInputs.length > 0) {
  proofInputs.forEach(function (proofInput) {
    return proofInput.addEventListener('change', uploadProofFile);
  });
}
